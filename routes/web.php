...
//show lists on admin dashboard
Route::get('category_list',[CategoryController::class,'category_list']);
Route::get('post_list',[CategoryController::class,'post_list']);
Route::get('comment_list',[CategoryController::class,'comment_list']);
Route::get('user_list',[CategoryController::class,'user_list']);
// Admin Routes
